...
- There is a file called `deploy-to-lasaths-test-vm.sh` that will build and deploy a sysext to a VM that you can connect to by running `ssh fernie@192.168.100.185`. If you need sudo, instead do `ssh root@192.168.100.185`.
